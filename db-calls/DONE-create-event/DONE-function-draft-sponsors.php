...
$query = "SELECT sum(CASE WHEN sponsor_dirette.id_diretta = '$idEvent' THEN 1 ELSE 0 END) as checked, sponsor.id, sponsor.system_date_created as data, sponsor.nome, sponsor.path_logo_nome as pic FROM sponsor
