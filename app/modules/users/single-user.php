    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div>
                ...
                <?php loadPartial('components/users/single-user', ['data' => $data]) ?>
                <!--end::Table widget 14-->
            </div>
        </div>
...
<?php loadPartial('components/users/modal-add-course', ['data' => $data])?>
<?php loadPartial('layout/bottom')?>
<?php loadPartial('layout/scripts/user-payments-history')?>
    <script>
