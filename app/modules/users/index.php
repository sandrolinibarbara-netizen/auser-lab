    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div>
                ...
                <?php loadPartial('components/users/all-users') ?>
                <!--end::Table widget 14-->
            </div>
            <div>
                <!--begin::Table widget 14-->
                <?php loadPartial('components/users/teachers') ?>
                <!--end::Table widget 14-->
            </div>
            <div>
                <!--begin::Table widget 14-->
                <?php loadPartial('components/users/admins') ?>
                <!--end::Table widget 14-->
            </div>
        </div>
...
<?php loadPartial('layout/scripts/all-users')?>
    <script>
