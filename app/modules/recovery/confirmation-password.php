    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="card w-75 my-10 text-center mx-auto p-7">
                ...
                <h2 class="mb-8 mt-2 d-flex align-items-center justify-content-center"><i class="ki-duotone ki-shield-tick fs-2hx text-success me-4"><span class="path1"></span><span class="path2"></span></i> Password cambiata con successo!</h2>
                <h5 class="w-75 mx-auto mb-6">Ora puoi effettuare l'accesso alla tua area personale.</h5>
