    ...
    <div id="kt_app_content" class="app-content flex-column-fluid my-10">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            <div class="container px-4">
                <form class="mb-8 border border-success rounded" id="form-on-demand">
                    <input class="form-control form-control-solid" id="search" placeholder="Cerca un corso on-demand"/>
