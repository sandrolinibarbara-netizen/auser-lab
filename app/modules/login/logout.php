...
<div class="bg-auser d-flex justify-content-center align-items-center">
    <div class="w-100 mx-10 d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex gap-4">
            <a class="btn btn-surface text-auser d-flex align-items-center text-hover-white better-hover px-6 py-1 h-45px" href="<?=ROOT.'dashboard?id='.$_SESSION[SESSIONROOT]['user']?>" style="border: #D9D9D9 solid 1px">
...
<div id="kt_app_content" class="app-content flex-column-fluid">
    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <div class="card w-75 my-10 text-center mx-auto p-7">
            ...
            <h2 class="mb-8 mt-2 d-flex align-items-center justify-content-center"><i class="ki-duotone ki-shield-tick fs-2hx text-success me-4"><span class="path1"></span><span class="path2"></span></i> Logout effettuato con successo!</h2>
...
<!--                Se la mail non è nello spam, o il link è scaduto, <a href="--><?php //= ROOT.'recupero/mail?type=2'?><!--">te ne inviamo un'altra</a>.</p>-->
            <div class="w-100 text-end">
                <a href="<?= ROOT . 'home?show=ecommerce'?>">&larr; Torna alla homepage</a>
            </div>
            <!--end::Table widget 14-->
        </div>
    </div>
