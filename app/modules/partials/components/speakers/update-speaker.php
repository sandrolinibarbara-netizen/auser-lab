    ...
    <div class="card-body">
        ...
        <div class="row mb-10">
            ...
            <div id="sponsor-pic" class="d-flex flex-column w-100">
                ...
                <div class="image-input image-input-empty bg-light-bg w-100 h-150px d-flex justify-content-center align-items-center" data-kt-image-input="true">
                    ...
                    <img id="pic" src="<?= ROOT.'app/assets/uploaded-files/speakers-images/'.$parsed[0]['path_immagine']?>" class="h-75"/>
                </div>
            </div>
        </div>
        <!--end::Input group-->
        ...
        <div class="row mb-6">
            ...
            <div class="col-6">
                ...
                <input class="form-control form-control-solid" type="text" name="cognome" id="cognome" value="<?=$parsed[0]['cognome']?>"/>
            </div>
        </div>
        <div class="row mb-6">
            <div class="col-12">
                <label class="form-label ms-2 mb-2" for="data-inizio">Professione</label>
                <input class="form-control form-control-solid" name="professione" id="professione" value="<?=$parsed[0]['professione']?>"/>
            </div>
        </div>
        <div class="row mb-6">
            <div class="col-6">
