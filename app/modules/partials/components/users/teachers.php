<div class="card h-md-100 my-8">
    ...
    <div class="card-header p-7">
        ...
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold text-gray-800">Insegnanti</span>
        </h3>
        <!--end::Title-->
    </div>
    <!--end::Header-->
    ...
    <div class="card-body pt-6">
        ...
        <div class="table-responsive">
            <!--begin::Table-->
            <table class="table align-middle table-row-dashed fs-6 gy-5 pb-8" id="kt_datatable_teachers_tab">
                <thead>
