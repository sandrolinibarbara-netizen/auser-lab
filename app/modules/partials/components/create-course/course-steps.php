    ...
    <form method="post" class="form card w-75 mx-auto" novalidate="novalidate" id="kt_stepper_course_form">
        ...
        <div>
            ...
            <div class="flex-column current" data-kt-stepper-element="content">
                ...
                <!--begin::Input group-->
                <div class="fv-row row card-body" id="categories-list">
            ...
            <div class="flex-column" data-kt-stepper-element="content">
                ...
                <div class="row mb-10">
                    ...
                    <div class="col-12">
                        <input class="form-control form-control-solid" type="text" id="path-video" name="path-video"/>
                    </div>
                </div>
                ...
                <!--begin::Input group-->
                    <div class="fv-row row mb-6">
                        ...
                        <div class="row mb-6">
                            <div class="col-12">
                                ...
                                <input class="form-control form-control-solid" type="text" name="nome" id="nome"/>
                            </div>
                        </div>
                    ...
                    <div class="fv-row row mb-6">
                        <div class="col-12">
                            ...
                            <input class="form-control form-control-solid" type="number" name="lezioni" id="lezioni"/>
                        </div>
                    </div>
                    <div class="fv-row row mb-6">
                        <div class="col-12">
                            <label class="form-label ms-2 mb-2" for="ore">Durata delle lezioni (in ore)</label>
                            <input class="form-control form-control-solid" type="number" name="ore" id="ore"/>
                        </div>
                    </div>

                    <div class="fv-row mb-6 d-flex gap-8 align-items-center">
                        <label class="form-label">Il corso è on-demand?</label>
                        <div class="form-check form-check-custom form-check-solid">
                            <label class="form-label ms-2 d-flex gap-2" for="on-demand-course">Sì
                                <input class="form-check-input" type="radio" name="on-demand" id="on-demand-course" value="1"/>
                            </label>
                        </div>
                        <div class="form-check form-check-custom form-check-solid">
                            <label class="form-label ms-2 d-flex gap-2" for="live-course">No
                                <input class="form-check-input" type="radio" name="on-demand" id="live-course" value="2"/>
                            </label>
                        </div>
                    </div>

                    <div class="row mb-6" id="course-dates">
                        <div class="fv-row col-6">
                            <label class="form-label ms-2 mb-2" for="data-inizio">Da</label>
                            <input class="form-control form-control-solid" name="data-inizio" id="data-inizio"/>
                        </div>
                        <div class="fv-row col-6">
                            <label class="form-label ms-2 mb-2" for="data-fine">A</label>
                            <input class="form-control form-control-solid" name="data-fine" id="data-fine"/>
                        </div>
                    </div>
                    <div class="fv-row mb-6">
                        <div class="col-12">
                            <label class="form-label ms-2 mb-2" for="descrizione">Descrizione del corso</label>
                            <textarea class="form-control form-control-solid" type="text" name="descrizione" id="descrizione"></textarea>
                        </div>
                    </div>
                    <div class="row mb-6">
                        <div class="fv-row col-4" id="fee">
                            <label class="form-label ms-2 mb-2" for="contributo">Contributo (in €)</label>
                            <input class="form-control form-control-solid" type="number" name="contributo" id="contributo"/>
                        </div>
                        <div class="fv-row col-4" id="min-students">
                            <label class="form-label ms-2 mb-2" for="min">Minimo studenti</label>
                            <input class="form-control form-control-solid" type="number" name="min" id="min"/>
                        </div>
                        <div class="fv-row col-4" id="max-students">
                            <label class="form-label ms-2 mb-2" for="max">Massimo studenti</label>
                            <input class="form-control form-control-solid" type="number" name="max" id="max"/>
                        </div>
                    </div>
                    <div class="fv-row row mb-10">
                        <div class="col-12">
                            ...
                            <select multiple class="form-select form-select-solid" data-control="select2" data-placeholder="Scegli uno o più insegnanti" name="insegnanti" id="insegnanti">
                                ...
                                <option value="<?=$teacher['id']?>"><?=$teacher['insegnante']?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
                    </div>
                    <div class="fv-row row mb-10" id="mode-type">
                        ...
                        <div class="col-3 form-check form-check-custom form-check-solid">
                            ...
                            <input class="form-check-input" type="radio" name="modalità" id="remoto" value="1"/>
                        </div>
                        <div class="col-3 form-check form-check-custom form-check-solid">
                            <label class="form-label ms-2 mb-2 d-flex gap-2" for="presenza">In presenza
                            <input class="form-check-input" type="radio" name="modalità" id="presenza" value="2"/>
                            </label>
                        </div>
                        <div class="col-3 form-check form-check-custom form-check-solid">
                            <label class="form-label ms-2 mb-2 d-flex gap-2" for="mista">Modalità mista
                                <input class="form-check-input" type="radio" name="modalità" id="mista" value="3"/>
                            </label>
                        </div>
                        <div class="col-3 form-check form-check-custom form-check-solid">
                            <label class="form-label ms-2 mb-2 d-flex gap-2" for="mod-boh">Da definire
                                <input class="form-check-input" type="radio" name="modalità" id="mod-boh" value="4"/>
                            </label>
                        </div>
                    </div>
                    <div class="fv-row row mb-10">
                        ...
                        <div class="col-3 form-check form-check-custom form-check-solid">
                            ...
                            <input class="form-check-input" type="radio" name="tesseramento" id="tess-yes" value="1"/>
                            </label>
                        </div>
                        <div class="col-3 form-check form-check-custom form-check-solid">
                            <label class="form-label ms-2 mb-2 d-flex gap-2" for="tess-no">No
                            <input class="form-check-input" type="radio" name="tesseramento" id="tess-no" value="0"/>
                            </label>
                        </div>
                        <div class="col-3 form-check form-check-custom form-check-solid">
                            <label class="form-label ms-2 mb-2 d-flex gap-2" for="tess-boh">Da definire
                                <input class="form-check-input" type="radio" name="tesseramento" id="tess-boh" value="2"/>
                            </label>
                        </div>
                    </div>
                    <div class="fv-row row">
                        ...
                        <div class="col-12">
                            <div class="btn p-6 d-flex gap-6 align-items-center btn-color-muted bg-light-bg text-auser form-check form-check-custom form-check-solid">
                                <input class="form-check-input" type="radio" name="visibilità" id="privato" value="1"/>
                    ...
                    <div class="row pt-3">
                        <div class="col-12">
                            <div class="btn p-6 d-flex gap-6 align-items-center btn-color-muted bg-light-bg text-auser form-check form-check-custom form-check-solid">
                            <input class="form-check-input" type="radio" name="visibilità" id="pubblico" value="0"/>
                                <div class="d-flex align-items-center gap-2 min-w-100px">
