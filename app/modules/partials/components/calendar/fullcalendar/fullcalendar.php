    ...
    <div class="card-header py-7">
        ...
        <div class="card-toolbar">
            <div class="m-0">
                ...
                <!--end::Menu toggle-->
                <!--begin::Menu 1-->
                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_filter_calendar-events">
                    <!--begin::Header-->
                    <div class="px-7 py-5">
                    ...
                    <div class="px-7 py-5">
                        ...
                        <div class="mb-10">
                            <!--begin::Label-->
                            <p class="form-label fw-semibold">Tipo:</p>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <div>
                                <label class="form-check-label" for="calendar-events-course">Corso</label>
                                <input value=1 type="radio" id="calendar-events-course" name="calendar-events-types" class="form-check-input" data-close-on-select="false" data-dropdown-parent="#kt_menu_filter_calendar-events" data-allow-clear="true"/>
                                <label class="form-check-label" for="calendar-events-event">Evento</label>
                                <input value=2 type="radio" id="calendar-events-event" name="calendar-events-types" class="form-check-input" data-close-on-select="false" data-dropdown-parent="#kt_menu_filter_calendar-events" data-allow-clear="true"/>
                                <label class="form-check-label" for="calendar-events-conference">Conferenza</label>
                                <input value=3 type="radio" id="calendar-events-conference" name="calendar-events-types" class="form-check-input" data-close-on-select="false" data-dropdown-parent="#kt_menu_filter_calendar-events" data-allow-clear="true"/>
                                <label class="form-check-label" for="calendar-events-all">Tutti</label>
                                <input value=4 type="radio" id="calendar-events-all" name="calendar-events-types" class="form-check-input" data-close-on-select="false" data-dropdown-parent="#kt_menu_filter_calendar-events" data-allow-clear="true"/>
                            </div>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
