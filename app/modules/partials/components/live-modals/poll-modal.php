<form class="modal fade rightFont" tabindex="-1" id="poll-modal" style="z-index: 2000">
    <div class="modal-dialog mw-800px">
        <div class="modal-content p-7">
            <div class="modal-header p-4 d-flex justify-content-between align-items-start">
                <div>
                    <h3 id="modal-poll-title fs-4" class="modal-title"></h3>
                    <h5 id="modal-poll-description fs-5" class="mt-2"></h5>
                </div>
                <!--begin::Close-->
