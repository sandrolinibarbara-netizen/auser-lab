...
<html lang="en">
<head>
    <title>Auser</title><meta charset="utf-8" />
    ...
    <link href="https://fonts.googleapis.com/css2?family=Lexend:wght@100..900&display=swap" rel="stylesheet">    <!--end::Fonts-->
    <!--begin::Vendor Stylesheets(used for this page only)-->
    <link href="<?=ROOT?>metronic/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
    ...
    <style>
        ...
        .better-hover-footer:hover {
            border-bottom: white solid 1px !important;
            box-sizing: border-box !important;
            border-radius: 0 !important;
        }
        .icon-hover:hover {
            border: #003E25 solid 1px !important;
