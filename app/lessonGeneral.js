...
videoButton.addEventListener('click', function (e) {
    e.preventDefault();
        ...
        formData.append('id', lesson.toString());
        ...
        if (xhr.status === 200) {
            ...
            if (chunkIndex < totalChunks) {
                ...
                source.setAttribute('src', 'https://storage.googleapis.com/auser-zoom-meetings' + lesson.toString() + '/' + $('#video-fileInput')[0].files[0].name);
